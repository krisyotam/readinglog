...
export function ActivityContent() {
  ...
  if (error) return <p className="text-gray-600">Error: {error.message}</p>
  ...
  return (
    <div className="space-y-8">
      ...
      {filteredBooks.length === 0 && <p className="text-gray-600 text-center">No books in this category yet.</p>}
    </div>
  )
}
